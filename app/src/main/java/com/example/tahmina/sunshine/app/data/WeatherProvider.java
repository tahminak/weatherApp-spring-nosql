...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(WeatherContract.WeatherEntry.CONTENT_URI.getAuthority(),WeatherContract.PATH_WEATHER,WEATHER);

        //Weather with location
        uriMatcher.addURI(WeatherContract.WeatherEntry.CONTENT_URI.getAuthority(),WeatherContract.PATH_WEATHER+"/*",WEATHER_WITH_LOCATION);


        //Weather with location Date
        uriMatcher.addURI(WeatherContract.WeatherEntry.CONTENT_URI.getAuthority(),WeatherContract.PATH_WEATHER+"/*/#",WEATHER_WITH_LOCATION_AND_DATE);

        //Weather with location
        uriMatcher.addURI(WeatherContract.WeatherEntry.CONTENT_URI.getAuthority(),WeatherContract.PATH_LOCATION,LOCATION);
